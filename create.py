    ...
    if submit:
        ...
        if not story_plot or not main_char or not main_char_desc:
            ...
            with st.spinner("Generating your story..."):
                ...
                story_title_prompt = f"Generate a title for the story: {ai_story}. Don\'t generate a list of story titles. Mention only 1 story title of 3 to 4 words. Just mention the title and nothing else."
