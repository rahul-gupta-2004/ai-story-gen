    ...
    if submit:
        ...
        if not story_plot or not main_char or not main_char_desc:
            ...
            with st.spinner("Generating your story..."):
                ...
                image_prompt = f"Generate an image for the story: {ai_story}."
                image = gen_ai_model.generate_image(image_prompt)

                # Generate a title for the story
                story_title_prompt = f"Generate a title for the story: {ai_story}. Do not generate a list of story titles. Mention only 1 story title of 3 to 4 words. Just mention the title and nothing else."
